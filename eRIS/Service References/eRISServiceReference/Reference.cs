...
namespace eRIS.eRISServiceReference {
    ...
    public partial class sGetPermissionsResult : object, System.ComponentModel.INotifyPropertyChanged {
        ...
        private bool isFollowUpEnabledField;
    ...
    public partial class eRISServiceClient : System.ServiceModel.ClientBase<eRIS.eRISServiceReference.eRISService>, eRIS.eRISServiceReference.eRISService {
        ...
        System.IAsyncResult eRIS.eRISServiceReference.eRISService.BeginSetPermissions(
                    ...
                    System.AsyncCallback callback, 
                    object asyncState) {
            return base.Channel.BeginSetPermissions(id, isAdmin, isRISAdmin, isManager, isRadiologist, isRadiologistADI, isTech, isClerk, isTelerad, isPhysician, isPatient, isCoder, ShortName, isCoderAssignable, RadGroup, isCoderLimited, isFollowUpEnabled, callback, asyncState);
        }
        ...
        private System.IAsyncResult OnBeginSetPermissions(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            bool isFollowUpEnabled = ((bool)(inValues[16]));
            return ((eRIS.eRISServiceReference.eRISService)(this)).BeginSetPermissions(id, isAdmin, isRISAdmin, isManager, isRadiologist, isRadiologistADI, isTech, isClerk, isTelerad, isPhysician, isPatient, isCoder, ShortName, isCoderAssignable, RadGroup, isCoderLimited, isFollowUpEnabled, callback, asyncState);
        }
        ...
        public void SetPermissionsAsync(
                    ...
                    bool isCoderLimited, 
                    bool isFollowUpEnabled) {
            this.SetPermissionsAsync(id, isAdmin, isRISAdmin, isManager, isRadiologist, isRadiologistADI, isTech, isClerk, isTelerad, isPhysician, isPatient, isCoder, ShortName, isCoderAssignable, RadGroup, isCoderLimited, isFollowUpEnabled, null);
        }
        ...
        public void SetPermissionsAsync(
            ...
            base.InvokeAsync(this.onBeginSetPermissionsDelegate, new object[] {
                        ...
                        RadGroup,
                        isCoderLimited,
                        isFollowUpEnabled}, this.onEndSetPermissionsDelegate, this.onSetPermissionsCompletedDelegate, userState);
        }
